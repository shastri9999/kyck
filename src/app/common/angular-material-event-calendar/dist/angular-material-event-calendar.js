(function () {
    ...
    angular.module('material.components.eventCalendar', []).config(addEventCalendarTheme);
    /*@ngInject*/
    function addEventCalendarTheme($injector, $provide, EVENT_CALENDAR_THEME, $rootScope) {
...
(function () {
    "use strict";
    angular.module("material.components.eventCalendar").run(["$templateCache", function ($templateCache) {
        $templateCache.put("icons/ic_close_black_24px.svg", "<svg fill=\"#000000\" height=\"24\" viewBox=\"0 0 24 24\" width=\"24\" xmlns=\"http://www.w3.org/2000/svg\">\n    <path d=\"M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z\"/>\n    <path d=\"M0 0h24v24H0z\" fill=\"none\"/>\n</svg>");
...
(function () {
    ...
    function eventCalendarDirective($injector, $parse) {
        controller.$inject = ["$$mdEventCalendarUtil", "$element", "$attrs", "$rootScope"];
        ...
        /*@ngInject*/
        function controller($$mdEventCalendarUtil, $element, $attrs, $rootScope) {
...
(function () {
    ...
    angular.module('material.components.eventCalendar').factory('$$mdEventCalendarBuilder', mdEventCalendarBuilderService);
    var nextId = 0;
    /**
     * @ngdoc service
    ...
    function mdEventCalendarBuilderService($$mdEventCalendarUtil, $templateCache) {
        ...
        function createShowMore(num, date, customText) {
            ...
            if (customText) showMoreElement.textContent = num + ' ' + customText;
...
(function () {
    "use strict";
    eventCalendarMonthDirective.$inject = ["$$mdEventCalendarBuilder", "$window", "$$rAF", "$timeout"];
    angular.module('material.components.eventCalendar').directive('mdEventCalendarMonth', eventCalendarMonthDirective);
    /**
     * @ngdoc directive
...
(function () {
    "use strict";
    angular.module('material.components.eventCalendar').directive('mdEventCalendarNext', mdEventCalendarNextDirective);
    /**
     * @ngdoc directive
    ...
    function mdEventCalendarNextDirective() {
        var directive = {
            restrict: 'E'
            , require: '^mdEventCalendar'
            , template: '<md-button class="md-icon-button" ng-click="mdEventCalendar.nextMonth()" aria-label="mext month">' + '<div class="md-arrow" ng-include="\'icons/ic_keyboard_arrow_right_black_24px.svg\'"></div>' + '</md-button>'
        };
        return directive;
    }
}());
(function () {
    "use strict";
    angular.module('material.components.eventCalendar').directive('mdEventCalendarPrev', mdEventCalendarPrevDirective);
    /**
     * @ngdoc directive
    ...
    function mdEventCalendarPrevDirective() {
        var directive = {
            restrict: 'E'
            , require: '^mdEventCalendar'
            , template: '<md-button class="md-icon-button" ng-click="mdEventCalendar.previousMonth()" aria-label="previous month">' + '<div class="md-arrow md-left-arrow" ng-include="\'icons/ic_keyboard_arrow_right_black_24px.svg\'"></div>' + '</md-button>'
        };
        return directive;
    }
}());
(function () {
    "use strict";
    angular.module('material.components.eventCalendar').directive('mdEventCalendarTitle', mdEventCalendarTitleDirective);
    /**
     * @ngdoc directive
...
(function () {
    "use strict";
    angular.module('material.components.eventCalendar').directive('mdEventCalendarToday', mdEventCalendarTodayDirective);
    /**
     * @ngdoc directive
...
(function () {
    ...
    angular.module('material.components.eventCalendar').factory('$$mdEventCalendarUtil', utilService);
