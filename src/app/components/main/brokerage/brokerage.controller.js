...
function BrokerageController($mdStepper, $mdDialog, $filter, $log, BrokerageResource, AuthenticationService, DocumentResource) {
    'ngInject';
    ...
    function nextStep() {
        // var eles = document.getElementsByClassName('md-stepper-indicator');
        // for (var i=1; i<=eles.length; i++) {
        // 	var ele = eles[i];
        // 	if (ele.className.indexOf('md-active') > -1) {
        // 		break;
        // 	}
        // }
